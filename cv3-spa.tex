...
\begin{tabularx}{\linewidth}{ @{}l r@{} }
\textbf{Homelab - Mini Rack} & \hfill \href{https://www.ianchenn.com/projects/homelab/}{Imagenes} \\[3.75pt]
\multicolumn{2}{@{}X@{}}{
Mini Rack con PC recicladas para correr servicios personales (self-hosting), deploy de proyectos, y aprendizaje y testeo de Linux. Tecnologias aprendidas: Proxmox, Linux, Debian, Ubuntu, Docker, Tailscale, Cloudflare, Crontab, Backups, SSH, Documentación. 
}  \\
\end{tabularx}
...
2025 - presente & Ingeniería Informática en \textbf{FIUBA} \hfill \normalsize  \\

2019 - 2024 & Colegio Nacional de Buenos Aires \textbf{(CNBA)} \hfill (Promedio: 8.7/10.0) \\ 
